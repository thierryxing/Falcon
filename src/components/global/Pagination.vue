  ...
  <ul :class="['pagination',btnSize]"
    ...
    <li v-if="showPrev" class="page-item">
      <a role="button"
         ...
         @keydown.space.prevent="setPage($event, 1)">1</a>
    </li>
    ...
    <li class="page-item" v-for="_,index in pageLinks" :key="index">
      <a role="button"
         ...
         @keydown.space.prevent="setPage($event, index + diff)">{{index + diff}}</a>
    </li>
    ...
    <li class="page-item" v-if="showNext">
      <a role="button"
         ...
         @keydown.space.prevent="setPage($event, numberOfPages)">{{numberOfPages}}</a>
    </li>
    ...
    <li v-else class="page-item">
      <a role="button"
         ...
         @click.prevent="setPage($event, currentPage + 1)"
         @keydown.enter.prevent="setPage($event, currentPage + 1)"
         @keydown.space.prevent="setPage($event, currentPage + 1)"><span aria-hidden="true">&raquo;</span></a>
    </li>
...
<style scoped>
  ...
  .page-item > a.active, .page-item > a.active:focus, .page-item > a.active:hover, .page-item > .active > span, .page-item > .active > span:focus, .page-item > .active > span:hover {
    z-index: 3;
    color: #fff;
    cursor: default;
